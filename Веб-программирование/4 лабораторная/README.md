...
#### Кнопка выхода  
![Выход из системы](screenshots/logout.png)  
*После нажатия происходит перенаправление на стартовую страницу.*  
...
*Компактное расположение, возможно сворачивание панелей.*  
